...
import com.rainbowsea.yupicturebackend.model.dto.user.UserAddRequest;
import com.rainbowsea.yupicturebackend.model.dto.user.UserLoginRequest;
import com.rainbowsea.yupicturebackend.model.dto.user.UserQueryRequest;
import com.rainbowsea.yupicturebackend.model.dto.user.UserRegisterRequest;
import com.rainbowsea.yupicturebackend.model.dto.user.UserUpdateRequest;
...
//
// --------------------------------------------------------------------------------------------------------------------------\
//                                  如下都是 admin 用户操作的，需要 admin 权限 才能访问
